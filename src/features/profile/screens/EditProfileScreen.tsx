            ...
            {lookingForOptions.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  lookingFor.includes(option.value) && styles.selectionButtonActive
                ]}
              >
                <Text style={[
                  styles.selectionButtonText,
                  lookingFor.includes(option.value) && styles.selectionButtonTextActive
                ]}>
                  {option.label}
                </Text>
              </TouchableOpacity>
          ...
          <View style={styles.selectionList}>
            {interestedInOptions.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.selectionButton,
                  interestedIn.includes(option.value) && styles.selectionButtonActive
                ]}
              >
                <Text style={[
                  styles.selectionButtonText,
                  interestedIn.includes(option.value) && styles.selectionButtonTextActive
                ]}>
                  {option.label}
                </Text>
              </TouchableOpacity>
          ...
          <View style={styles.selectionList}>
            {languagesOptions.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.selectionButton,
                  languages.includes(option.value) && styles.selectionButtonActive
                ]}
              >
                <View style={styles.languageRow}>
                  ...
                  <Text style={[
                    styles.selectionButtonText,
                    languages.includes(option.value) && styles.selectionButtonTextActive
                  ]}>
                    {option.label}
                  </Text>
                </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.interestsGrid}>
            {interestsOptions.map((option) => (
              <TouchableOpacity
                key={option.value}
                onPress={() => toggleInterest(option.label)}
                style={[
                  styles.interestChip,
                  interests.includes(option.label) && styles.activeChip
                ]}
              >
                <Text style={[
                  styles.interestText,
                  interests.includes(option.label) && styles.activeText
                ]}>
                  {option.label}
                </Text>
              </TouchableOpacity>
